...
<script type="text/javascript">
	...
	// 版权信息
	function showAbout(){
		$.messager.alert("物流管理系统 v1.0","管理员邮箱: ZZULiuDingxin@163.com");
	}
</script>
...
<body class="easyui-layout">
	<div data-options="region:'north',border:false"
		style="height:80px;background:url('./images/header_bg.png') no-repeat right;">
		<div>
			<img height="80px" width="90px" src="${pageContext.request.contextPath }/images/zzu.jpg"
				border="0">
		</div>
		...
		<div id="layout_north_kzmbMenu" style="width: 100px; display: none;">
			...
			<div onclick="showAbout();" data-options="iconCls:'icon-search'">联系管理员</div>
	...
	<div data-options="region:'south',border:false"
		style="height:50px;padding:10px;background:url('./images/header_bg1.png') no-repeat right;">
		<table style="width: 100%;">
			<tbody>
				<tr>
					<td style="width: 300px;">
						<div style="color: #999; font-size: 8pt;">
							郑州大学 | Powered by <a href="http://www.zzu.edu.cn/">zzu.edu.cn</a>
						</div>
					</td>
