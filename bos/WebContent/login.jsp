...
<body>
	<div
		style="width: 900px; height: 120px; position: absolute; text-align: left; left: 50%; top: 50%; margin-left: -450px; margin-top: -320px;">
		<img src="${pageContext.request.contextPath }/images/logo.jpg" style="border-width: 0; margin-left: 0;width: 400px; height: 100px;" />
	</div>
	...
	<div
		...
		<span style="color: #488ED5;">Powered By http://www.zzu.edu.cn/</span><span
		...
		</span><span style="float: right; color: #488ED5;">BOS物流管理系统系统</span>
	</div>
</body>
</html>